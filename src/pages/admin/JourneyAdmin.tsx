...
const defaultMilestones: Milestone[] = [
  {
    ...
    description: 'Completed SSC from Notre Dame College, Dhaka. The first step in a remarkable academic journey that would shape my future.',
    category: 'education',
  ...
  },
  {
    ...
    description: 'Graduated from Notre Dame College with HSC. A defining moment that solidified my connection to the NDC community.',
    category: 'education',
  ...
  },
  {
    id: '3',
    year: '2005',
    title: 'B.Sc in Engineering - BUET',
    description: 'Earned Bachelor of Science in Engineering from Bangladesh University of Engineering and Technology (BUET), one of the most prestigious institutions in the country.',
    category: 'education',
    image: 'https://images.unsplash.com/photo-1695204906099-8d6394c2752f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbmdpbmVlcmluZyUyMGNvbGxlZ2UlMjBjYW1wdXN8ZW58MXx8fHwxNzY0MzU5MTkyfDA&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  },
  {
    id: '4',
    year: '2006',
    title: 'Production Officer - Fakir Apparels Ltd',
    description: 'Started professional career in the RMG industry as a Production Officer, beginning the journey in garment manufacturing.',
    category: 'career',
  ...
  },
  {
    id: '5',
    year: '2008',
    title: 'Unit Manager - Fakir Apparels Ltd',
    description: 'Promoted to Unit Manager, taking on greater responsibilities in production management and team leadership.',
    category: 'career',
  ...
  },
  {
    id: '6',
    year: '2010',
    title: 'General Manager - Fakir Apparels Ltd',
    description: 'Advanced to General Manager position, overseeing complete production operations and strategic planning.',
    category: 'career',
  ...
  },
  {
    id: '7',
    year: '2013-2022',
    title: 'Managing Partner - Manvill Styles Ltd',
    description: 'Co-founded and served as Managing Partner at Manvill Styles Ltd, building a successful garment manufacturing enterprise.',
    category: 'business',
  ...
  },
  {
    id: '8',
    year: '2018',
    title: 'NDC99 Batch Committee - Founder',
    description: 'Founded the NDC99 Batch Committee to strengthen bonds and organize alumni activities for Notre Dame College Batch 1999.',
    category: 'community',
  ...
  },
  {
    id: '9',
    year: '2019',
    title: 'SSC97HSC99 Executive Committee',
    description: 'Elected to the SSC97, HSC99 Executive Committee, serving the Notre Dame community with dedication from 2019-2023.',
    category: 'leadership',
  ...
  },
  {
    id: '12',
    year: '2023',
    title: 'General Manager - Beximco Group',
    description: 'Joined Beximco Industrial Park Ltd as General Manager, contributing to one of Bangladesh\'s largest conglomerates.',
    category: 'career',
    image: 'https://images.unsplash.com/photo-1758630737900-a28682c5aa69?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMG9mZmljZSUyMG1vZGVybnxlbnwxfHx8fDE3NjQyNDMxODN8MA&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  },
  {
    ...
    description: 'Currently serving as Senior General Manager of Operations at Lantabur Sourcing BD Ltd, driving operational excellence.',
    category: 'career',
    image: 'https://images.unsplash.com/photo-1758630737900-a28682c5aa69?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMG9mZmljZSUyMG1vZGVybnxlbnwxfHx8fDE3NjQyNDMxODN8MA&ixlib=rb-4.1.0&q=80&w=1080',
